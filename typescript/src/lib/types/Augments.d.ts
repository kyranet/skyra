...
import type { ModelStore, YoutubeSubscriptionHandler } from '#lib/grpc';
...
declare module '@sapphire/framework' {
	...
	interface SapphireClient {
		...
		emit(event: Events.YoutubeNotification, notification: YoutubeSubscriptionHandler.SubscriptionNotificationResult): boolean;
